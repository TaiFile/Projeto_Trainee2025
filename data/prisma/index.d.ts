...
export namespace Prisma {
  ...
  */
  ...
  export interface Prisma__ListClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    Task<T extends List$TaskArgs<ExtArgs> = {}>(args?: Subset<T, List$TaskArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$TaskPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
  ...
  export type TaskOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "completed" | "listId", ExtArgs["result"]["task"]>
  ...
  export type ListUpdateOneRequiredWithoutTaskNestedInput = {
    ...
    connect?: ListWhereUniqueInput
    update?: XOR<XOR<ListUpdateToOneWithWhereWithoutTaskInput, ListUpdateWithoutTaskInput>, ListUncheckedUpdateWithoutTaskInput>
  }
